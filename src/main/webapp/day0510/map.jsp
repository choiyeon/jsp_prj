...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=124058c84f0b38081f791a55030295e3"></script>
<script type="text/javascript">
	$(function(){
		var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	    mapOption = { 
	        center: new kakao.maps.LatLng(37.4993731,127.0332047), // 지도의 중심좌표
	        level: 3 // 지도의 확대 레벨
	    };
	...
	// 마커가 표시될 위치입니다 
	var markerPosition  = new kakao.maps.LatLng(37.4993731,127.0332047); 
