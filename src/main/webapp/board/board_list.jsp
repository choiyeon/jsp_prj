...
try{
	...
	//1.총 레코드의 수 얻기
	int totalCount=bDAO.selectTotoalCount( sVO );
	//2.한 화면에 보여줄 게시물의 수 
	int pageScale=10;
	//3.총 페이지수
...
%>
	...
	<table class="table">
		...
		<tr>
		<td><c:out value="${ totalCount - ( currentPage - 1 ) * pageScale - i.index }"/></td><!-- 숫자거꾸로 출력하기 마지막번호~첫번호-->
