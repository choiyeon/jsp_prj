...
<a href="jstl_choose.jsp?type=admin">관리자</a>]<br>
...
<hr>
<!-- 1. 0 또는 1의 난수를 발생시켜, scope객체저장 -->
<form action="">
<%
int flag = (int)(Math.random()*2);
pageContext.setAttribute("rn", flag);
%>

<!-- 2. name="gender"인 hidden에 value속성에 scope객체의 값을 설정 -->
<input type="hidden" name="gender" value="${ pageScope.rn }">
<input type="submit" value="전송"/>
</form>

<div>
<!-- 3. submit이 클릭되면 parameter 값이 존재하고, parameter가 있을 때
