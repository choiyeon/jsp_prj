...
<label>hidden</label>
<input type="hidden" name="hid" value="hidden 정명호"><br/>
...
<select name="loc">
	...
	<option value="충청남북도" selected="selected">충청도</option>
	<option value="경상남북도">경상도</option>
	<option value="전라남북도">전라도</option>
	<option value="제주 한랑봉">제주도</option>
</select><br/>
...
<input type="text" name="name"/><br/>
<label>취미</label>
<input type="checkbox" name="hobby" value="등산"/><br/>
<input type="checkbox" name="hobby" value="낚시"/><br/>
<input type="checkbox" name="hobby" value="수영"/><br/>
...
<select name="loc">
	...
	<option value="경상남북도">경상도</option>
	<option value="전라남북도">전라도</option>
	<option value="제주 한랑봉" selected="selected">제주도</option>
</select><br/>
<label>textarea</label>
<textarea style="width: 300px; height:100px" name="ta">POST연습</textarea>
<br/>
<label>이름</label>
<input type="text" name="name" value="최수연"/><br/>
<label>이름</label>
<input type="text" name="name" value="김수연"/><br/>
<label>이름</label>
<input type="text" name="name" value="이수연"/><br/>
<label>취미</label>
