...
<c:import url="http://192.168.10.218/day0430/jstl_import_b.jsp"/>
<!-- include action tag는 uri만 사용가능. -->
<%-- <jsp:include page="jstl_import_b.jsp"/> --%>
<%-- <jsp:include page="http://192.168.10.218/day0430/jstl_import_b.jsp"/> url사용불가 --%>
</div>
외부 JSP
</div>
</body>
