...
%>
<c:if test="${ empty pVO }">
	<c:redirect url="http://192.168.10.218/jsp_prj/day0502/index.jsp"/>
</c:if>
...
<br>
<img src="http://192.168.10.218/jsp_prj/upload/${ pVO.img }" id="previewProfile" style="width: 100px"/>
<br>
<label>ID</label> : <input type="text" name="id" id="id" value="${ pVO.id }" readonly="readonly"/><br/>
