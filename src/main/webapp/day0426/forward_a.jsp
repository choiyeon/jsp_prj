...
<%= nameTitle %> : <input type="text" name="name" value=""/><br/>
<%= ageTitle %> : <input type="text" name="age" value=""/><br/>
<input type="submit" value="전송" class="btn btn-info btn-sm"/>
</form>
<a href="http://localhost:8598/jsp_prj/day0426/forward_a.jsp">local요청</a>
<a href="http://192.168.10.218/jsp_prj/day0426/forward_a.jsp">외부 ip 요청</a>
</div>
</body>
</html>