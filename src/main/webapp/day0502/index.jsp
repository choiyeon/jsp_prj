...
<style type="text/css">
	#wrap{ width: 1462px;height: 749px; margin: 0px auto;
			position: relative; background: #FFFFFF url('http://192.168.10.218/jsp_prj/day0502/sist_homepage.png')}
...
<div id="wrap">
	<div id="memberDiv">
	<a href="http://192.168.10.218/jsp_prj/member/${ url }" class="memberLink"><c:out value="${ sessionScope.loginData.name }${ pageScope.title }"/></a> | 
	<a href="http://192.168.10.218/jsp_prj/member/member_join_frm.jsp" class="memberLink">회원가입</a> |
	<a href="http://192.168.10.218/jsp_prj/board/board_list.jsp" class="memberLink">게시판</a>
	</div>
</div>
</body>
</html>