...
%>
	...
	<li><span>요청 Server Name</span> : <%= request.getServerName() %></li>
	...
	<li><span>QueryStirng 얻기</span> : <%= request.getQueryString() %></li>
	<li><span>web parameter(요청 값)얻기</span> : <%= request.getParameter("name") %></li>
	<li><span>web parameter(요청 값)얻기</span> : <%= request.getParameter("age") %></li>
	...
	[<a href="http://192.168.10.210/jsp_prj/day0419/request.jsp?name=정명호&age=25&age=24">다른 서버로 요청 | </a>
	<a href="http://192.168.10.218/day0419/request.jsp?name=정명호&age=25&age=24">localhost요청 ]</a>
</div>
</body>
</html>